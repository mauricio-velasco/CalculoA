...
\noindent{\bf II} Para los siguientes ejercicios haga en \verb!pyplot! un dibujo de la función en la región de interés, estime el vaolr del límite y luego demuestre la validez de su estimación con las reglas de cálculo de límites:
